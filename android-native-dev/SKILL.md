...
description: Android native application development and UI design guide. Covers Material Design 3 (M3 Expressive), Kotlin coroutine safety & lifecycle rules, Product Flavors & Build Variants configuration, accessibility (A11y), and build error diagnosis/troubleshooting. Read this before building Android UI screens, styling components, configuring Gradle flavors, or fixing build errors.
license: MIT
metadata:
  version: "1.0.0"
  category: mobile
